...
- ⬜ Pendiente: penalización por error de procedimiento (sección 4, fila 3) — sigue siendo propuesta, no tiene un disparador concreto en el código todavía (no hay timer por visitante, solo por día).
- ⬜ Pendiente: las 3 compras nuevas (pista, tiempo extra, seguro) y el botón de "Tienda" en el HUD.
